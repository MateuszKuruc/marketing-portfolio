...
const Project = ({ params }: Params) => {
  ...
  return (
    <div className="py-8 max-container padding-container bg-gradient-to-br from-gray-90">
      {CLIENT_DATA.map((client) =>
        client.id.toString() === id ? (
          <>
            <h1 className="text-blue-50 bold-52 lg:bold-70 mb-4">
              {client.title}
            </h1>
            ...
            <h2 className="text-blue-50 bold-40 lg:bold-52 my-5">
              Podsumowanie
            </h2>
