...
const Hero = () => {
  return (
    <section
      id="hero"
      className="mt-4 lg:mt-10 border-b-4 border-white skew-y-3 bg-gradient-to-t from-gray-90 to-gray-30 max-container padding-container flex flex-col flexCenter xs:py-5 md:py-10 md:gap-28 lg:py-20"
    >
